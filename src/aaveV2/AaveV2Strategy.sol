...
import {IAaveV2Strategy, ILendingPoolV2, ILendingPoolAddressesProviderV2, IWrappedNativeToken, IVariableDebtToken, DataTypes} from "src/aaveV2/IAaveV2Strategy.sol";
    ...
    function collateralSwap(
        ...
        (, bytes memory receivedToken) = dataProvider.staticcall(
            abi.encodeWithSignature(
                ...
                suppliedCollateralToken
            )
        );
        (address aToken, , ) = abi.decode(
            receivedToken,
